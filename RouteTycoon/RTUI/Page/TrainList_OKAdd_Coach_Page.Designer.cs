...
{
	partial class TrainList_OKAdd_Coach_Page
	{
		/// <summary> 
		/// 필수 디자이너 변수입니다.
		/// </summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbTitle.Size = new System.Drawing.Size(278, 40);
			this.lbTitle.TabIndex = 17;
			this.lbTitle.Text = "(okaddcoach)";
			// 
			// panListBack
			// 
			...
			this.Name = "TrainList_OKAdd_Coach_Page";
