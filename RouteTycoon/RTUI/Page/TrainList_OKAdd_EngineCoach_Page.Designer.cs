...
{
	partial class TrainList_OKAdd_EngineCoach_Page
	{
		/// <summary> 
		/// 필수 디자이너 변수입니다.
		/// </summary>
		...
		private void InitializeComponent()
		{
			...
			this.lbTitle.Size = new System.Drawing.Size(404, 40);
			this.lbTitle.TabIndex = 17;
			this.lbTitle.Text = "(okaddenginecoach)";
			// 
			// panListBack
			// 
			...
			this.lbAdd.Text = "(add)";
			// 
			// TrainList_OKAdd_EngineCoach_Page
			// 
			...
			this.Name = "TrainList_OKAdd_EngineCoach_Page";
			this.Size = new System.Drawing.Size(800, 600);
			this.Paint += new System.Windows.Forms.PaintEventHandler(this.TrainList_OKAdd_EngineCoach_Page_Paint);
