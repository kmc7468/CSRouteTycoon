...
{
	partial class StationAdd_Name_Page
	{
		/// <summary> 
		/// 필수 디자이너 변수입니다.
		/// </summary>
		...
		private void InitializeComponent()
		{
			...
			this.Name = "StationAdd_Name_Page";
			this.Size = new System.Drawing.Size(800, 600);
			this.Load += new System.EventHandler(this.StationAdd_Name_Page_Load);
			this.Paint += new System.Windows.Forms.PaintEventHandler(this.StationAddPage_Paint);
