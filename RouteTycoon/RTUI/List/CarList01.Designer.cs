namespace RouteTycoon.RTUI
{
	partial class CarList01
	{
		...
		private void InitializeComponent()
		{
			...
			// picUp
			// 
			this.picUp.Location = new System.Drawing.Point(458, 5);
			...
			// picDown
			// 
			this.picDown.Location = new System.Drawing.Point(494, 5);
			...
			this.Click += new System.EventHandler(this.CarList01_Click);
			this.Paint += new System.Windows.Forms.PaintEventHandler(this.CarList01_Paint);
			this.MouseEnter += new System.EventHandler(this.CarList01_MouseEnter);
			this.MouseLeave += new System.EventHandler(this.CarList01_MouseLeave);
